...
interface GlobalConstant{
    ...
    int NM_TAXI = 0;//普通出租车
    int VIP_TAXI = 1;//VIP出租车
    int SEPARATOR = 70;//普通出租车与VIP出租车分界线
    ...
    int NODE_NUM = ROW_NUMBER*COL_NUMBER;//节点数
    int EDGE_NUM = ROW_NUMBER*(COL_NUMBER-1)+COL_NUMBER*(ROW_NUMBER-1);//边数目
    //有关时间的常量值
    double gridConsume = 0.2;//一个格子行驶耗时200ms
    double singleWaitMax = 20.0;//处于连续等待最大时间
    double stopInterval = 1.0;//停止状态1s
    ...
    //有关道路请求的常量值
    String OPEN_ROAD = "open";//开启路
    String CLOSE_ROAD = "close";//关闭某个路
    int openRoad = 1;
    int closeRoad = 2;

    int INF = 65535;
    //关于请求的常量值
    String PASSENGER = "CR";//乘客请求
    String SEARCH = "SR";//搜索请求
    String ROAD = "RR";//道路请求
    ...
    String LIGHT_NAME = "light.txt";//定义红绿灯文件名
    ...
    //有关红绿灯的常量值
    int HAVE_LIGHT = 1;//路口有红绿灯
    int NOT_LIGHT = 0;//路口没有红绿灯
    int LIGHT_GREEN = 1;//东西向为绿灯,南北向为红灯
    int LIGHT_RED = 2;//东西向为红灯,南北向为绿灯
