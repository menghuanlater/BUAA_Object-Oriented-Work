 ...
 * 出租车的相关信息
 */
public class NMTaxi implements GlobalConstant,Cloneable{
    /*
    ...
    @Override
    synchronized public NMTaxi clone(){
        /*@REQUIRES:None
        @MODIFIES:None
        ...
        */
        NMTaxi NMTaxi = null;
        try {
            NMTaxi = (NMTaxi)super.clone();
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
        }
        //assert NMTaxi!=null;/* if copy failed,throw error. */
        return NMTaxi;
    }
